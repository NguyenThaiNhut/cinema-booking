...
from .views import (
    ListMovieAPIView, MovieAPIView, PosterUploadAPIView, SearchMovieAPIView, FilterMovieAPIView,
...
urlpatterns = [
    ...
    path("admin-user/movie/upload-poster-movie/<int:movie_id>/", PosterUploadAPIView.as_view(), name="upload-movie-poster"),
